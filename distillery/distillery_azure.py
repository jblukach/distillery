...
class DistilleryAzure(Stack):
    ...
    ### LAMBDA LAYERS ###
        ...
        beautifulsoup4 = _lambda.LayerVersion.from_layer_version_arn(
            self, 'beautifulsoup4',
            layer_version_arn = 'arn:aws:lambda:'+region+':'+extensions.string_value+':layer:beautifulsoup4:3'
        )
    ...
    ### LAMBDA ###
        ...
        compute = _lambda.Function(
            ...
            code = _lambda.Code.from_asset('sources/azure'),
