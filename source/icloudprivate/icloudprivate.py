...
def handler(event, context):
    ...
    r = requests.get('https://mask-api.icloud.com/egress-ip-ranges.csv', headers=headers)
    ...
    if r.status_code == 200:
        ...
        for cidr in output:
            ...
            if len(parsed[2]) == 0:
                f.write(os.environ['SOURCE']+','+now+','+parsed[0]+','+str(firstip)+','+str(lastip)+','+parsed[1]+',-,'+parsed[3]+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            else:
