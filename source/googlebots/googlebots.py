...
def handler(event, context):
    ...
    r = requests.get('https://developers.google.com/search/apis/ipranges/googlebot.json', headers=headers)
    ...
    if r.status_code == 200:
        ...
        for cidr in output['prefixes']:
            ...
            try:
                ...
                f.write('googlebots,'+now+','+cidr['ipv4Prefix']+','+str(firstip)+','+str(lastip)+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass
            ...
            try:
                ...
                f.write('googlebots,'+now+','+cidr['ipv6Prefix']+','+str(firstip)+','+str(lastip)+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass
