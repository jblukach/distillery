...
def handler(event, context):
    ...
    if r.status_code == 200:
        ...
        f = open('/tmp/googlefetchers.csv', 'w')
        ...
        for cidr in output['prefixes']:
            ...
            try:
                ...
                f.write('googlefetchers,'+now+','+cidr['ipv4Prefix']+','+str(firstip)+','+str(lastip)+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass
            ...
            try:
                ...
                f.write('googlefetchers,'+now+','+cidr['ipv6Prefix']+','+str(firstip)+','+str(lastip)+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass
        ...
        s3.meta.client.upload_file(
            '/tmp/googlefetchers.csv',
            os.environ['S3_BUCKET'],
            'sources/googlefetchers.csv',
            ExtraArgs = {
