    ...
    if r.status_code == 200:
        ...
        for cidr in output['prefixes']:
            ...
            try:
                ...
                f.write(os.environ['SOURCE']+','+now+','+cidr['ipv4Prefix']+','+str(firstip)+','+str(lastip)+','+cidr['scope']+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass
            ...
            try:
                ...
                f.write(os.environ['SOURCE']+','+now+','+cidr['ipv6Prefix']+','+str(firstip)+','+str(lastip)+','+cidr['scope']+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass
