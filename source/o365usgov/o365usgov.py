...
def handler(event, context):
    ...
    r = requests.get('https://endpoints.office.com/endpoints/USGOVGCCHigh?clientrequestid='+str(uuid.uuid4()), headers=headers)
            ...
            try:
                if len(cidr['ips']) != 0:
                    for ip in cidr['ips']:
                        ...
                        f.write(os.environ['SOURCE']+','+now+','+ip+','+str(firstip)+','+str(lastip)+',-,'+cidr['serviceArea']+',-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-,-\n')
            except:
                pass 
