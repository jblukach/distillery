    ...
    if r.status_code == 200:
        ...
        for cidr in output['prefixes']:
            ...
            try:
                ...
                f.write(os.environ['SOURCE']+','+cidr['service']+','+cidr['scope']+','+cidr['ipv4Prefix']+','+str(firstip)+','+str(lastip)+'\n')
            except:
                pass
            ...
            try:
                ...
                f.write(os.environ['SOURCE']+','+cidr['service']+','+cidr['scope']+','+cidr['ipv6Prefix']+','+str(firstip)+','+str(lastip)+'\n')
            except:
                pass
