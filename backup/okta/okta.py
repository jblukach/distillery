...
def handler(event, context):
    ...
    r = requests.get('https://s3.amazonaws.com/okta-ip-ranges/ip_ranges.json', headers=headers)
    ...
    if r.status_code == 200:
        ...
        for key in output:
            for cidr in output[key]['ip_ranges']:
                ...
                f.write(os.environ['SOURCE']+','+os.environ['SOURCE']+','+key+','+cidr+','+str(firstip)+','+str(lastip)+'\n')
