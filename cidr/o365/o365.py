...
def downloader(instance, latest, parameter, link):
    ...
    if r.status_code == 200:
        ...
        print('o365 '+instance+' IP Ranges Updated')
...
def handler(event, context):
    ...
    if r.status_code == 200:
        ...
        for version in versions:
            if version['instance'] == 'Worldwide':
                ...
                if prevtoken != str(version['latest']):
                    print('Updating o365 Worldwide IP Ranges')
                ...
                prevtoken = response['Parameter']['Value']
                if prevtoken != str(version['latest']):
                    print('Updating o365 USGovDoD IP Ranges')
                ...
                prevtoken = response['Parameter']['Value']
                if prevtoken != str(version['latest']):
                    print('Updating o365 USGovGCCHigh IP Ranges')
                ...
                prevtoken = response['Parameter']['Value']
                if prevtoken != str(version['latest']):
                    print('Updating o365 China IP Ranges')
                ...
                prevtoken = response['Parameter']['Value']
                if prevtoken != str(version['latest']):
                    print('Updating o365 Germany IP Ranges')
        ...
        print('No o365 IP Range Updates')
